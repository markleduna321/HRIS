...
const navigation = [
  ...
  { name: 'Attendance', href: '/attendance', icon: ClipboardDocumentListIcon, permission: 'view attendance' },
  { name: 'Leaves', href: '/leaves', icon: CalendarIcon, permission: 'view leaves' },
  { name: 'Payroll', href: '/payroll', icon: BanknotesIcon, permission: 'view payroll' },
  { name: 'Performance', href: '/performance', icon: ChartPieIcon, permission: 'view performance' },
  { name: 'User Management', href: '/users', icon: Cog6ToothIcon, permission: 'view users' },
];
...
export default function AppLayout({ children }) {
  ...
  useEffect(() => {
    ...
    const filteredNavigation = navigation.filter(item => {
      ...
      // Admin and Super Admin roles have access to everything
      if (userRoles.includes('super_admin') || userRoles.includes('admin')) return true;
      
      return userPermissions.includes(item.permission);
    });

    const updatedNavItems = filteredNavigation.map((item) => ({
      ...item,

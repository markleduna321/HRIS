...
const navigation = [
  ...
  { name: 'Users', href: '/users', icon: UsersIcon, role: ['admin', 'hr_manager'] },
  { name: 'Roles', href: '/roles', icon: ShieldCheckIcon, role: ['admin', 'hr_manager'] },
  { name: 'Permissions', href: '/permissions', icon: KeyIcon, role: ['admin', 'hr_manager'] },
];
